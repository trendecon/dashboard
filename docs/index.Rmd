...
<font size="3.5">
[Download data](https://raw.githubusercontent.com/trendecon/data/master/daily/trendecon_all.csv){target="_blank"}
</font>
...
<font size="4.5">
<p align="justify">
The data can be accessed [here](https://github.com/trendecon/data){target="_blank"}. Our indicator data is public and freely available under license Attribution-NonCommercial-ShareAlike 3.0 Unported [CC BY-NC-SA 3.0](https://creativecommons.org/licenses/by-nc-sa/3.0/){target="_blank"}.
This means that you can remix, adapt, and build upon this work non-commercially, as long as you credit us and license your new creations under the identical terms. [Source](https://creativecommons.org/licenses/){target="_blank"}
</p>
</font>
...
- [Angelica Becerra](https://www.linkedin.com/in/angelicambg/){target="_blank"} (Statistician and Programmer, ETH KOF)
