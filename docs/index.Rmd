...
dygraph(trendecon_all_sa,group = "keywords")%>%
  ...
  dyEvent("2020-4-27", "Reopening - Phase I", labelLoc = "bottom") %>%
  dyEvent("2020-5-11", "Reopening - Phase II", labelLoc = "bottom") %>%
  dyEvent("2020-6-8", "Reopening - Phase III", labelLoc = "bottom") %>%
...
#### **Ein neuer Indikator zur Homeoffice-Situation und was dieser mit Black Friday zu tun hat**

<font size="2">1. November 2020</font><br>
<font size="2">Alexander Götz</font>

Das Homeoffice brachte neue Objekte auf die Einkaufslisten der Konsumenten. Waren die eigenen vier Wände vorher klar fürs Wohnen bestimmt, müssen sie nun auch arbeitstauglich sein. Es ist kein Geheimnis, dass vermehrt Monitore, Anschlusskabel und andere Arbeitsobjekte besorgt werden mussten (siehe z.B. [Bloomberg](https://www.bloomberg.com/news/articles/2020-03-17/pc-monitors-in-short-supply-as-virus-spurs-home-office-buying){target="_blank"}). 

TrendEcon hat sich zum Anlass genommen typische Gegenstände des Homeoffice-Alltags zu einem Index zusammenzufassen. Der Home Office Index enthält die Suchbgeriffe "headset","monitor","maus" und "hdmi". Wahrscheinlich haben Sie selbst im Frühling oder Herbst mindestens einen dieser Begriffe gegoogelt. Denn der Index zeigt starke Bewegungen zu den verschiedenen Lockdowns. Im März war der Ausschlag ausgesprochen stark. Nach einem Rückgang im Sommer folgte wieder eine vermehrte Nachfrage nach den Homeoffice-Elektronika. Der folgende Chart zeigt 7-Tage-Schnitte des neuen täglichen Indikators.
...
Der Vergleich mit den Vorjahren zeigt, dass die leichte Baisse im Sommer 2020 immer noch über dem Interesse vorheriger Sommer liegt. Interessant ist auch die Beobachtung, dass gegen Ende November in allen dargestellten Jahren die Nachfrage nach Elektronikartikeln zunimmt. Wieso schlägt der Indikator denn an den Novemberenden aus?

Die Antwort ist schnell gefunden: Black Friday! Die Rabattschlacht erfreut seit wenigen Jahren auch die Schweizer Konsumenten. Wie sich denn der Black Friday und die darauf folgende Cyber Week auf die Nachfrage nach Elektronikartikeln und deren Händler, wie Galaxus oder Interdiscount, ausgewirkt haben erfahren Sie im nächsten Blog. 
...
#### **A new indicator for the home office situation and what it has to do with Black Friday**

<font size="2">November 1st, 2020</font><br>
<font size="2">Alexander Götz</font>


The home office brought new items to consumers' shopping lists. While the own four walls were intended for living only before, it must now be suitable for work. It is no secret that people started buying more monitors, connection cables, and other work objects (see, e.g., [Bloomberg](https://www.bloomberg.com/news/articles/2020-03-17/pc-monitors-in-short-supply-as-virus-spurs-home-office-buying){target="_blank"}). 

TrendEcon has taken the opportunity to summarize specific home office objects in an index. The home office index contains the search terms "headset," "monitor", "maus" (computer mouse), and "hdmi". You probably googled at least one of these terms yourself in spring or autumn. The index shows strong movements during the two semi-lockdowns. Especially in March, the rash was unmissably large. After a decline in the summer, demand for home office electronics increased again. The following chart shows 7-day rolling averages of the new daily indicator.
...
Compared with previous years, the decline in summer is still above the average level of searches from the last years. Interestingly, towards the end of November, the demand for electronic goods increased in all the years shown. So why does the indicator rise at the end of November?

Short answer: Black Friday! The discount battle has also been delighting Swiss consumers for a few years now. In the next blog, you can read about how Black Friday and the Cyber Week impacted the demand for electronic goods and their retailers, such as Galaxus or Interdiscount.
