...
Home {.storyboard}
=====================================
### Project idea {data-commentary-width=400}
...
- Consumer confidence is established as a key driver of economic activity.

- Like in other countries, there is an index available for Switzerland.

- However, this is expensive (surveys) and only available quarterly.

- We use Google Trends to provide a complementary tool: Fast, cheap, and agile tracking of consumer confidence.


### Project Contribution and Target Groups {data-commentary-width=400}
...
### Consumer Confidence - Idea and Definition {data-commentary-width=400}
