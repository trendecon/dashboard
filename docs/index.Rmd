...
dygraph(trendecon_all_sa,group = "keywords")%>%
  ...
  dyEvent("2020-12-22", "Facilities closed", labelLoc = "bottom") %>%
  dyEvent("2021-01-18", "Compulsory homeworking", labelLoc = "bottom") %>%
  dyEvent("2021-03-01", "Opening some facilities", labelLoc = "bottom") %>%
  dyEvent("2021-04-19", "Outdoor restaurants open", labelLoc = "bottom") %>%
  dyEvent("2021-05-31", "Easing measures", labelLoc = "bottom") %>%
